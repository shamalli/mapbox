<script>
	...
	"use strict";
		...
		$(function() {
			...
			$("#expiration_date").datepicker($.datepicker.regional[ "<?php echo esc_js($lang_code); ?>" ]);
			<?php endif; ?>
...
<div class="w2mb-content">
	<div class="w2mb-field w2mb-form-group w2mb-form-horizontal">
		<label class="w2mb-col-md-1 w2mb-control-label">
			<?php esc_html_e('Date:', 'W2MB'); ?>
		</label>
		<div class="w2mb-col-md-3">
			<div class="w2mb-has-feedback">
				<input type="text" id="expiration_date" class="w2mb-form-control" />
				<span class="w2mb-glyphicon w2mb-glyphicon-calendar w2mb-form-control-feedback"></span>
			</div>
		</div>
		<label class="w2mb-col-md-1 w2mb-control-label"><?php esc_html_e('Time:', 'W2MB'); ?></label>
		<div class="w2mb-col-md-3">
			...
			<select name="expiration_date_hour" class="w2mb-form-control">
		...
		<div class="w2mb-col-md-3">
			<select name="expiration_date_minute" class="w2mb-form-control">
