<div class="w2mb-form-group w2mb-field w2mb-field-input-block w2mb-field-input-block-<?php echo esc_attr($content_field->id); ?>">
	...
	<div class="w2mb-col-md-10">
		<input type="text" name="w2mb-field-input-<?php echo esc_attr($content_field->id); ?>" class="w2mb-field-input-number w2mb-form-control" value="<?php echo esc_attr($content_field->value); ?>" size="4" />
